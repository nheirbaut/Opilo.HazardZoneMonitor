...
public sealed class OutlineTests
{
    ...
    {
        // Arrange
        var vertices = new ReadOnlyCollection<Location>(new[] { new Location(0, 0), new Location(1, 1) });
    ...
    {
        // Arrange
        var vertices = new ReadOnlyCollection<Location>(new[]
        {
            new Location(0, 0), new Location(4, 0), new Location(4, 4), new Location(0, 4)
        });
    ...
    public void IsLocationInside_ShouldWorkForConcavePolygons()
    {
        ...
        var vertices = new ReadOnlyCollection<Location>(new[]
        {
            new Location(0, 0), new Location(4, 0), new Location(2, 2), new Location(4, 4), new Location(0, 4)
        });
        var outline = new Outline(vertices);
